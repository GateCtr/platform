...
const contentEn = {
  ...
  dataNote:
    "In accordance with GDPR and our data retention policy, any residual data will be purged within 30 days.",
...
const contentFr = {
  ...
  dataNote:
    "Conformément au RGPD et à notre politique de rétention, les données résiduelles seront purgées dans les 30 jours.",
  contact:
    "Si vous n'avez pas demandé cette suppression ou avez des questions, contactez-nous à",
