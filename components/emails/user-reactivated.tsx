...
export default function UserReactivatedEmail({ email, name, locale = "en" }: UserReactivatedEmailProps) {
...
const contentEn = {
  preview: "Your GateCtr account has been reactivated.",
  hi: "Hi", hiDefault: "Hi,",
  headline: "Your account is active again.",
  body: "Your GateCtr account has been reactivated. You can sign in and resume using the platform immediately.",
  cta: "Open dashboard",
...
const contentFr = {
  preview: "Votre compte GateCtr a été réactivé.",
  hi: "Bonjour", hiDefault: "Bonjour,",
  headline: "Votre compte est à nouveau actif.",
  body: "Votre compte GateCtr a été réactivé. Vous pouvez vous connecter et reprendre l'utilisation de la plateforme immédiatement.",
...
const button = { backgroundColor: "#1B4F82", borderRadius: "6px", color: "#ffffff", fontSize: "15px", fontWeight: "600", padding: "12px 28px", textDecoration: "none", display: "inline-block" };
