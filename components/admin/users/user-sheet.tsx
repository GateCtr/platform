                ...
                <>
                  ...
                  <div className="px-6 py-4 flex flex-col gap-2">
                    ...
                    >
                      ...
                      {t("actions.changePlan")} — {user.plan}
                    </Button>
                  </div>
                    ...
                    <div className="rounded-lg border border-border overflow-hidden divide-y divide-border">
                      ...
                      {user.isActive && !user.isBanned ? (
                        ...
                        >
                          ...
                          <span className="flex-1 font-medium text-amber-700 dark:text-amber-400">
                            {t("actions.suspend")}
                          </span>
                        </button>
                      ) : (
                    ...
                    <div className="rounded-lg border border-error-500/20 overflow-hidden divide-y divide-error-500/10">
                      {!user.isBanned && (
                        ...
                        >
                          ...
                          <span className="flex-1 font-medium text-error-700 dark:text-error-400">
                            {t("actions.ban")}
                          </span>
                        </button>
                      )}
